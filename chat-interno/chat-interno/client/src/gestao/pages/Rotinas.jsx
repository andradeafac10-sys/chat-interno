...
const styles = {
  ...
  explicacao: { fontSize: 12, color: 'var(--pagina-texto-2)', marginTop: 8, marginBottom: 16, maxWidth: 620 },
  hint: { color: 'var(--pagina-texto-2)', fontSize: 14 },
  error: { color: '#ef4444', fontSize: 14 },
  list: { display: 'flex', flexDirection: 'column', gap: 10, paddingBottom: 24 },
  card: { background: 'var(--pagina-cartao)', border: '1px solid #E4E8EE', borderRadius: 10, padding: 14 },
  ...
  badgeInativa: {
    background: 'var(--pagina-borda-suave)', color: 'var(--pagina-texto-2)', fontSize: 10, fontWeight: 700,
    padding: '2px 8px', borderRadius: 999,
  },
  cardDescricao: { fontSize: 13, color: 'var(--pagina-texto-2)', margin: '6px 0 0' },
  cardMeta: { fontSize: 12, color: 'var(--pagina-texto-2)', marginTop: 6, display: 'flex', gap: 6, flexWrap: 'wrap' },
  assigneesRow: { display: 'flex', gap: 6, marginTop: 8, flexWrap: 'wrap' },
  assigneeChip: { background: 'var(--pagina-borda-suave)', color: '#1c4270', fontSize: 11, padding: '3px 9px', borderRadius: 999 },
